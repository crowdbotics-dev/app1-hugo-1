"""
Django settings for app1_hugo_1 project.
...
WSGI_APPLICATION = 'app1_hugo_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app1_hugo_1 API",
    "DESCRIPTION": "API documentation for app1_hugo_1 App",
    "VERSION": "v1",
}
